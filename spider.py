...
class myntraApi():
    def __init__(self):
        ...
        title = ['Crawling Time','Product Rank','Product Url','Category','Name','Brand','Product Id','Description','Seller','Average Rating','Total Rating','Total Reviews','Star1 Count','Star2 Count','Star3 Count','Star4 Count','Star5 Count','List Price','Sale Price','Product Details','Fit','Product Image']
        self.page_no = 1
    ...
    def product_details(self, url):
        ...
        return description, fit, stars, reviews_count, seller_name
    ...
    def get_product(self, product):
        ...
        if productUrl in self.done:
            return
        product_details, fit, stars, totalReviews, seller = self.product_details(productUrl)
